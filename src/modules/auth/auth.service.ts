...
//     const refreshTokenResult = (await this.tokenService.verifyToken(
//       refreshToken.refreshToken,
//       TokenType.REFRESH,
//     )) as { userId: number; jti: string };
//     const user = await this.findById(refreshTokenResult.userId);
//     if (!user) {
//       throw new NotFoundException({ message: 'User Not Found' });
//     }
//     await this.tokenService.deleteToken(refreshTokenResult.jti);
...
//     await this.tokenService.deleteToken(verifiedToken.jti);
//   }
// }
